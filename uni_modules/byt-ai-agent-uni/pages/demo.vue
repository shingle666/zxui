<template>
    <view>
        <byt-dialogue-demo :config="agentConfig"></byt-dialogue-demo>
    </view>
</template>

<script>
import BytDialogueDemo from '../components/agent-dialogue/byt-dialogue-demo/byt-dialogue-demo.vue';
export default {
    components: { BytDialogueDemo },
    data() {
        return {};
    },
    computed: {
