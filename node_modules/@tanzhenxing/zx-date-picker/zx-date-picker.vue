<template>
  <view
    ...
    :class="[`zx-date-picker--${type}`, { 'zx-date-picker--disabled': disabled }]"
  >
    <!-- 输入框部分 -->
    <view class="zx-date-picker__input-wrapper" @click="handleOpen">
      <view
        class="zx-date-picker__input"
        :class="{ 'zx-date-picker__input--focus': visible }"
      >
        <!-- 前缀图标 -->
    ...
    >
      ...
      <view class="zx-date-picker__toolbar">
        ...
        <view class="zx-date-picker__toolbar-btn" @click="handleConfirm">
          <text
            class="zx-date-picker__toolbar-text zx-date-picker__toolbar-text--confirm"
            >{{ confirmText }}</text
          >
        </view>
      </view>
