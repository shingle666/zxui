      ...
      <view class="zx-goods-sku2-header">
        ...
        <view class="zx-goods-sku2-goods-info">
          <image 
            v-if="goods.image" 
            :src="goods.image" 
            class="zx-goods-sku2-goods-image"
            mode="aspectFill"
          />
        ...
        <view class="zx-goods-sku2-content-wrapper">
            ...
            <view class="zx-goods-sku2-spec-list">
              ...
              >
                <image 
                  v-if="option.image" 
                  :src="option.image" 
                  class="zx-goods-sku2-spec-item-img"
                  mode="aspectFill"
                />
          ...
          <view class="zx-goods-sku2-stepper">
            ...
            <view class="zx-goods-sku2-stepper-content">
              <view 
                class="zx-goods-sku2-stepper-btn"
                :class="{ 'zx-goods-sku2-stepper-btn-disabled': quantity <= stepperMin }"
              ...
              <input 
                ...
                class="zx-goods-sku2-stepper-input"
                type="number"
                :min="stepperMin"
                :max="stepperMax"
              ...
              <view 
                class="zx-goods-sku2-stepper-btn"
                :class="{ 'zx-goods-sku2-stepper-btn-disabled': quantity >= stepperMax }"
                @click="changeQuantity(1)"
              >
                <text class="zx-goods-sku2-stepper-btn-text">+</text>
              </view>
      ...
      <view class="zx-goods-sku2-operate">
        ...
        <view class="zx-goods-sku2-operate-btns">
          <view 
            ...
            :key="btn"
            class="zx-goods-sku2-operate-btn"
            :class="[
