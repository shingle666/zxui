  ...
  <zx-popup v-model="showPopup" position="bottom" :safe-area-inset-bottom="true"
    ...
    <view class="zx-address">
      ...
      <view v-if="showTabs" class="zx-address__tabs">
        <view v-for="(tab, index) in tabs" :key="index" class="zx-address__tab"
          :class="{ 'zx-address__tab--active': activeTab === index }" @click="onTabClick(index)">
          {{ tab.title }}
        </view>
      </view>
      ...
      <view class="zx-address__content">
        ...
        <view v-if="activeTab === 0" class="zx-address__custom">
          ...
          <view class="zx-address__picker">
            <zx-picker-view :value="pickerValue" :columns="pickerColumns" @change="onPickerChange"
        ...
        <view v-if="activeTab === 1" class="zx-address__exist">
          ...
          <scroll-view class="zx-address__exist-list" scroll-y>
            <view v-for="(item, index) in existAddress" :key="item.id" class="zx-address__exist-item"
              ...
              <view class="zx-address__exist-item-icon">
                <zx-icon :name="item.selectedAddress ? 'success' : 'circle'"
                  :color="item.selectedAddress ? '#1989fa' : '#c8c9cc'" size="16"></zx-icon>
              </view>
...
import zxPickerView from '@tanzhenxing/zx-picker-view/zx-picker-view.vue';
