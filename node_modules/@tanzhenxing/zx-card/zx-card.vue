<template>
  ...
  >
    ...
    <slot name="cover">
      <view
        v-if="cover"
        class="zx-card__cover"
        :style="{ 'border-radius': coverRadius + 'rpx' }"
      >
        <image
          class="zx-card__cover-image"
          :mode="coverMode"
    ...
    <slot name="title">
      <view v-if="title || extra" class="zx-card__header">
        ...
        <view class="zx-card__header-box" @click.stop="onClick('title')">
          ...
          >
            <image
              class="zx-card__header-avatar-image"
              :src="thumbnail"
              :mode="avatarMode"
              :lazy-load="lazyLoad"
            />
          ...
          <view class="zx-card__header-content">
            <text
              class="zx-card__header-content-title zx-ellipsis"
              :style="{
