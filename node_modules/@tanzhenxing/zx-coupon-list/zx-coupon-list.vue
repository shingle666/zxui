  ...
  <view :class="['zx-coupon-list', customClass]" :style="customStyle">
    ...
    <view v-if="showExchangeBar" class="zx-coupon-list__exchange-bar">
      <view class="zx-coupon-list__field">
        ...
        <view 
          v-if="currentCode" 
          class="zx-coupon-list__clear"
          @tap="clearCode"
        >
          <text class="zx-coupon-list__clear-icon">×</text>
        </view>
      </view>
      <view 
        class="zx-coupon-list__exchange-btn"
        :class="{ 'zx-coupon-list__exchange-btn--disabled': buttonDisabled }"
        @tap="onExchange"
      >
    ...
    <view class="zx-coupon-list__tabs">
      <view 
        class="zx-coupon-list__tab"
        :class="{ 'zx-coupon-list__tab--active': activeTab === 0 }"
        @tap="switchTab(0)"
      >
      ...
      <view 
        class="zx-coupon-list__tab"
        :class="{ 'zx-coupon-list__tab--active': activeTab === 1 }"
        @tap="switchTab(1)"
      >
        <text class="zx-coupon-list__tab-text">
    ...
    <!-- 优惠券列表 -->
    <scroll-view 
      class="zx-coupon-list__list"
      :class="{ 'zx-coupon-list__list--with-bottom': showCloseButton }"
      ...
      <view v-if="activeTab === 0">
        ...
        <view v-if="!coupons.length" class="zx-coupon-list__empty">
          <image 
            v-if="emptyImage" 
            :src="emptyImage" 
            class="zx-coupon-list__empty-image"
          />
    ...
    <view v-if="showCloseButton" class="zx-coupon-list__bottom">
      <slot name="list-button">
        <view 
          class="zx-coupon-list__close-btn"
          @tap="closeCouponList"
        >
