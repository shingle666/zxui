    ...
    <zx-form ref="formRef" :model="formData" :rules="formRules">
      <view class="zx-address-edit__fields">
        ...
        <zx-form-item label="手机号" name="tel">
          <zx-input type="tel" v-model="formData.tel" placeholder="收货人手机号" :maxlength="props.telMaxlength"
            @focus="onFocus('tel')" @input="onInputChange('tel', $event)" />
        </zx-form-item>
        <zx-form-item v-if="props.showArea" label="地区" name="areaCode">
          <zx-area :area-list="props.areaList" :value="formData.areaCode" :columns-num="props.areaColumnsNum"
            :columns-placeholder="props.areaColumnsPlaceholder" @confirm="onAreaConfirm" @cancel="onAreaCancel"
            style="width: 100%;"></zx-area>
        </zx-form-item>
        <zx-form-item v-if="props.showDetail" label="详细地址" name="addressDetail">
          <zx-textarea v-model="formData.addressDetail" placeholder="街道门牌、楼层房间号等信息" auto-height
            :maxlength="props.detailMaxlength" :rows="props.detailRows" @focus="onFocus('addressDetail')"
      ...
      <view v-if="!hideBottomFields" class="zx-address-edit__buttons">
        ...
        <zx-button v-if="props.showDelete" block round :loading="props.isDeleting" @click="onDelete"
