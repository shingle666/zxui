<template>
	<view class="zx-fav"
		:class="[circle ? 'zx-fav--circle' : '', disabled ? 'zx-fav--disabled' : '']"
		:style="[{ backgroundColor: checked ? bgColorChecked : bgColor }]"
		@click="!disabled && onClick()">
		<!-- #ifdef MP-ALIPAY -->
		<view v-if="star && !checked" class="zx-fav__star">
			<zx-icon :color="fgColor" :style="{ color: checked ? fgColorChecked : fgColor }" :size="iconSize" :name="iconName"></zx-icon>
		</view>
		<!-- #endif -->

		<!-- #ifndef MP-ALIPAY -->
		<zx-icon v-if="star && !checked" :color="fgColor" :style="{ color: checked ? fgColorChecked : fgColor }" class="zx-fav__star" :size="iconSize" :name="iconName"></zx-icon>
		<!-- #endif -->
