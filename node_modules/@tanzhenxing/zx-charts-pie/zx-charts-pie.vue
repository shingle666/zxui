<template>
  <view class="zx-charts__pie-wrap" :class="{ 'zx-charts__pie-vertical': legend.direction !== 'vertical' }">
    <view class="zx-pie__legend" :class="{ 'zx-legend__flex-column': legend.direction === 'vertical' }"
      v-if="legend.show">
      <view class="zx-pie__legend-item" :style="{ marginLeft: legend.direction === 'vertical' ? '0' : '24rpx' }"
    ...
    <view class="zx-charts__pie-box" :style="{
      width: diam + 'rpx',
      height: diam + 'rpx',
      backgroundColor: backgroundColor,
    }">
      <view class="zx-charts__pie-itembox" :style="{
        width: diam / 2 + 2 + 'rpx',
        height: diam + 'rpx',
        ...
        <view class="zx-charts__pie-item" :style="{
          width: diam / 2 + 'rpx',
          height: diam + 'rpx',
      ...
      <view class="zx-charts__pie-annular" v-if="type == 2" :style="{
