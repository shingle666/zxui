<template>
  <button :form-type="formType" :open-type="openType" :type="realType" :plain="plain" :disabled="disabled"
    :hover-class="getHoverClass" :hover-start-time="hoverStartTime" :hover-stay-time="hoverStayTime"
    :hover-stop-propagation="hoverStopPropagation" :app-parameter="appParameter" :lang="lang"
    :session-from="sessionFrom" :send-message-title="sendMessageTitle" :send-message-path="sendMessagePath"
    :send-message-img="sendMessageImg" :show-message-card="showMessageCard" :group-id="groupId" :guild-id="guildId"
    :public-id="publicId" :data-im-id="dataImId" :data-im-type="dataImType" :data-goods-id="dataGoodsId"
    :data-order-id="dataOrderId" :data-biz-line="dataBizLine" :size="sizeToStandard" :class="[
      'zx-button',
    ...
    ]" :style="buttonStyle" @getphonenumber="getPhoneNumber" @getuserinfo="getUserInfo" @error="error"
    @opensetting="openSetting" @launchapp="launchApp" @contact="contact" @chooseavatar="chooseAvatar"
    @agreeprivacyauthorization="agreePrivacyAuthorization" @addgroupapp="addGroupApp" @chooseaddress="chooseAddress"
    @chooseinvoicetitle="chooseInvoiceTitle" @subscribe="subscribe" @login="login" @im="im" @click="click">
