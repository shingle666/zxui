<template>
	<view class="zx-calendar">
		<view v-if="!insert && show" class="zx-calendar__mask" :class="{ 'zx-calendar--mask-show': aniMaskShow }"
			@click="clean"></view>
		<view v-if="insert || show" class="zx-calendar__content"
			:class="{ 'zx-calendar--fixed': !insert, 'zx-calendar--ani-show': aniMaskShow }">
			...
			<view class="zx-calendar__box">
				...
				<view class="zx-calendar__weeks" v-for="(item, weekIndex) in weeks" :key="weekIndex">
					<view class="zx-calendar__weeks-item" v-for="(weeks, weeksIndex) in item" :key="weeksIndex">
						<calendar-item class="zx-calendar-item--hook" :weeks="weeks" :calendar="calendar"
