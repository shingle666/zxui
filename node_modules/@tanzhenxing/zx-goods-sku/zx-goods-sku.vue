    ...
    <view class="zx-goods-sku" :class="customClass" :style="customStyle" @click.stop>
      ...
      <view class="zx-goods-sku-header">
        <view class="zx-goods-sku-close" @click="close">
          <text class="zx-goods-sku-close-icon">×</text>
        </view>
        <view class="zx-goods-sku-goods-info">
          <image 
            v-if="goods.image" 
            :src="goods.image" 
            class="zx-goods-sku-goods-image"
            mode="aspectFill"
          />
        ...
        <view class="zx-goods-sku-content-wrapper">
          ...
          <view v-for="(spec, specIndex) in skuList" :key="spec.id" class="zx-goods-sku-spec">
            ...
            <view class="zx-goods-sku-spec-list">
              <view 
                v-for="(option, optionIndex) in spec.list" 
                :key="option.id"
                class="zx-goods-sku-spec-item"
                :class="{
          ...
          <view class="zx-goods-sku-stepper">
            ...
            <view class="zx-goods-sku-stepper-content">
              <view 
                class="zx-goods-sku-stepper-btn"
                :class="{ 'zx-goods-sku-stepper-btn-disabled': quantity <= stepperMin }"
              ...
              <input 
                ...
                class="zx-goods-sku-stepper-input"
                type="number"
                :min="stepperMin"
                :max="stepperMax"
              ...
              <view 
                class="zx-goods-sku-stepper-btn"
                :class="{ 'zx-goods-sku-stepper-btn-disabled': quantity >= stepperMax }"
                @click="changeQuantity(1)"
              >
                <text class="zx-goods-sku-stepper-btn-text">+</text>
              </view>
      ...
      <view class="zx-goods-sku-operate">
        ...
        <view class="zx-goods-sku-operate-btns">
          <view 
            ...
            :key="btn"
            class="zx-goods-sku-operate-btn"
            :class="`zx-goods-sku-operate-btn-${btn}`"
