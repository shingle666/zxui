<template>
  ...
  >
    ...
    <view class="zx-ecard__content">
      ...
      <view class="zx-ecard__main">
        ...
        <view v-if="description" class="zx-ecard__description">
          <text 
            class="zx-ecard__description-text"
            :style="{
        ...
        <view v-if="condition" class="zx-ecard__condition">
          <text 
            class="zx-ecard__condition-text"
            :style="{
      ...
      <view class="zx-ecard__action">
        ...
        <view 
          ...
          class="zx-ecard__button"
          :class="`zx-ecard__button--${buttonType}`"
          :style="{ backgroundColor: buttonColor }"
          @click.stop="handleButtonClick"
        >
          <text 
            class="zx-ecard__button-text"
            :style="{
    ...
    <!-- 状态遮罩 -->
    <view 
      v-if="status === 'used' || status === 'expired'"
      class="zx-ecard__mask"
    >
