    ...
    >
      ...
      >
        ...
        <view :class="getIconCls()">
          ...
          <component v-else-if="getItemIcon(item, index)" :is="getItemIcon(item, index)" />
        </view>
        ...
        <view :class="getHeaderBoxCls(item)">
          ...
          <view :class="getTitleCls()">
            <!-- Collapse Icon -->
            <text 
              v-if="enableCollapse && item.content && !isRTL"
              :class="getCollapseIconCls(item)"
        ...
        <view v-if="item.extra" :class="getExtraCls()">
          <text v-if="typeof item.extra === 'string'">{{ item.extra }}</text>
          <component v-else :is="item.extra" />
        </view>
      </view>
      
      <!-- Content -->
      <view 
        v-if="item.content && getContentVisible(item)"
        :class="getContentCls()"
      ...
      >
        <text v-if="typeof item.footer === 'string'">{{ item.footer }}</text>
        <component v-else :is="item.footer" />
      </view>
    </view>
  </view>
</template>
...
// 定义组件名称
defineOptions({ name: 'ZxAiThoughtChain' })
