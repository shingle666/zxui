<template>
  <view class="zx-charts__scatter-wrap" :style="{ width: width + 'rpx' }">
    ...
    <view class="zx-charts__scatter-box" :style="{ width: width + 'rpx', height: height + 'rpx' }">
      <view class="zx-xAxis__line" v-for="(item, index) in xAxisData" :key="item.id" :style="{
      ...
      <view class="zx-yAxis__line" v-for="(item, index) in yAxisData" :key="item.id" :style="{
      ...
      <view v-for="(item, index) in dataset" :key="item.id">
        <view @tap.stop="onDotTap(index, idx)" class="zx-scatter__item" :class="{
          'zx-scatter__item-active':
            activeIdx === idx && activeIndex === index && tooltipShow,
        }" v-for="(model, idx) in item.source" :key="idx" :style="{
