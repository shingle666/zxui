  ...
  <view :class="[
    ...
    <view class="zx-delivery__section">
      ...
      <view class="zx-delivery__methods">
        <view v-for="method in deliveryMethods" :key="method.value" :class="[
          'zx-delivery__method',
          {
          ...
          <view class="zx-delivery__method-icon">
            <zx-icon :name="method.icon" :size="iconSize"
          ...
          <view class="zx-delivery__method-radio">
            <zx-icon :name="selectedMethod === method.value ? 'radio-checked' : 'radio-unchecked'" :size="radioSize"
    ...
    <view v-if="showTimeSelect && selectedMethod" class="zx-delivery__section">
      ...
      <view class="zx-delivery__times">
        <view v-for="time in availableTimes" :key="time.value" :class="[
          'zx-delivery__time',
          {
    ...
    <view v-if="showAddress && selectedMethod" class="zx-delivery__section">
      ...
      <view class="zx-delivery__address" @click="handleAddressSelect">
    ...
    <view v-if="showRemark && selectedMethod" class="zx-delivery__section">
      ...
      <view class="zx-delivery__remark">
        <zx-textarea v-model="deliveryRemark" :placeholder="remarkPlaceholder" :maxlength="remarkMaxlength"
          :rows="remarkRows" auto-height @input="handleRemarkChange" />
      </view>
    </view>
