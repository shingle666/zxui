<template>
  <view class="zx-hiteggs" :style="containerStyle">
    <view class="zx-hiteggs__container">
      <!-- 锤子 -->
      <view class="zx-hiteggs__hammer" :class="{ 'zx-hiteggs__hammer--hitting': isHitting }" :style="hammerStyle"
        v-if="showHammer">
        <image :src="hammerImg" mode="aspectFit" class="zx-hiteggs__hammer-img" />
      </view>

      <!-- 金蛋网格 -->
      <view class="zx-hiteggs__grid" :style="gridStyle">
        <view v-for="(egg, index) in eggs" :key="index" class="zx-hiteggs__egg-item" :style="eggItemStyle"
          @click="hitEgg(index)">
          <!-- 完整金蛋 -->
          <view v-if="!egg.isHit" class="zx-hiteggs__egg" :class="{ 'zx-hiteggs__egg--shaking': egg.isShaking }">
            <image :src="intactImg" mode="aspectFit" class="zx-hiteggs__egg-img" :style="eggImageStyle" />
          </view>
          ...
          <view v-else class="zx-hiteggs__broken">
            ...
            <view class="zx-hiteggs__broken-effect">
              <view v-for="(fragment, fIndex) in 6" :key="fIndex" class="zx-hiteggs__fragment"
                :class="`zx-hiteggs__fragment--${fIndex + 1}`">
                <image :src="brokenImg" mode="aspectFit" class="zx-hiteggs__fragment-img" />
              </view>
            </view>
            ...
            <view class="zx-hiteggs__prize" v-if="egg.prize">
              <view class="zx-hiteggs__prize-content">
                <image v-if="egg.prize.image" :src="egg.prize.image" mode="aspectFit" class="zx-hiteggs__prize-img" />
