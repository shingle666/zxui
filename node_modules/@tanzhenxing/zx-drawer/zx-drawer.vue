<template>
  <view>
    <!-- 遮罩层 -->
    <view v-if="modelValue && modal" class="zx-drawer__mask" :style="{ zIndex: zIndex }" @click="handleClickModal">
    </view>

    <!-- 抽屉内容 -->
    <view class="zx-drawer" :class="[
      `zx-drawer--${direction}`,
      customClass,
      ...
      <view v-if="withHeader" class="zx-drawer__header" :class="headerClass">
        ...
        <view v-if="showClose" class="zx-drawer__close-btn" @click="handleClose">
