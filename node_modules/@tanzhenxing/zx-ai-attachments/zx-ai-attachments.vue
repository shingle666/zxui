...
import ZxAttachmentItem from './components/zx-attachment-item.vue';
import ZxAttachmentPlaceholder from './components/zx-attachment-placeholder.vue';

// 定义组件名称
defineOptions({
  name: 'ZxAiAttachments'
});
