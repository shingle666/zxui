<template>
  <view class="zx-horizontal-scrolling" :style="containerStyle">
    <!-- 左侧遮罩 -->
    <view v-if="showMask && maskPosition === 'left'"
      class="zx-horizontal-scrolling__mask zx-horizontal-scrolling__mask--left" :class="[
        `zx-horizontal-scrolling__mask--${maskShadowType}`,
        { 'zx-horizontal-scrolling__mask--transparent': maskShadowType === 'transparent' }
      ]" :style="leftMaskStyle" @click="handleMaskClick">
    ...
    <!-- 滚动容器 -->
    <scroll-view class="zx-horizontal-scrolling__container" :style="scrollContainerStyle" scroll-x
      :show-scrollbar="false" :scroll-left="scrollLeft" @scroll="handleScroll">
    ...
    <!-- 右侧遮罩 -->
    <view v-if="showMask && maskPosition === 'right'"
      class="zx-horizontal-scrolling__mask zx-horizontal-scrolling__mask--right" :class="[
        `zx-horizontal-scrolling__mask--${maskShadowType}`,
        { 'zx-horizontal-scrolling__mask--transparent': maskShadowType === 'transparent' }
      ]" :style="rightMaskStyle" @click="handleMaskClick">
      <view class="zx-horizontal-scrolling__mask-box">
        <slot name="maskContent" v-if="$slots.maskContent"></slot>
        <template v-else-if="maskContent">
          <zx-html :content="maskContent"></zx-html>
