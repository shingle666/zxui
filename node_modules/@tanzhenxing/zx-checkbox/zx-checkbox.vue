<template>
  <view class="zx-checkbox" :style="[checkboxStyle]" @tap.stop="wrapperClickHandler" :class="[
    ...
    <view class="zx-checkbox__icon-wrap" @tap.stop="iconClickHandler" :class="[
      iconClasses,
      indeterminate ? 'zx-checkbox__icon-wrap--indeterminate' : '',
      isChecked ? 'zx-checkbox__icon-wrap--checked' : '',
    ]" :style="[iconWrapStyle]">
      <slot name="icon">
        <zx-icon class="zx-checkbox__icon-wrap__icon" :name="indeterminate ? 'minus' : 'checkbox-mark'"
          :size="elIconSize" :color="elIconColor"></zx-icon>
      </slot>
    </view>
