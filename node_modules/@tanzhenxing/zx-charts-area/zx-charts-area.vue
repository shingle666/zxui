      ...
      <scroll-view :scroll-x="scrollable" class="zx-line__scroll-view" :style="{ height: scrollViewH + 'rpx' }">
        ...
        <view class="zx-charts__line" :style="{ height: height + 'rpx' }">
          ...
          <view v-for="(line, idx) in lines" :key="line.id">
            <view class="zx-charts__broken-line" v-for="(l, k) in line.source" :key="l.id" :style="{
          ...
          <view class="zx-area__chart-box" v-for="(area, i) in dots" :key="area.key" :style="{
            left: xGap / 2 + 'rpx',
            right: xGap / 2 + 'rpx',
            minWidth: xWidth + 'rpx',
          }">
            <view class="zx-area__item" :style="{
