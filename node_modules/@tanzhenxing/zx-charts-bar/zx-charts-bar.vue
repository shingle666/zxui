<template>
  <view class="zx-charts__bar-wrap" :style="{ width: width + 'rpx' }">
    ...
    <view class="zx-charts__bar-box" :style="{ borderLeftColor: yAxisLine.color, borderBottomColor: xAxisLineColor }"
      ...
      <view class="zx-charts__bar-item" :class="{
        ...
        <view class="zx-bar__yAxis-text" :style="{
          color: yAxisLabel.color || '#333',
          fontSize: (yAxisLabel.size || 24) + 'rpx',
        }">
          {{ item }}
        </view>
        <view class="zx-yAxis__tickmarks" :style="{
          width: yAxisTick.width || '12rpx',
          backgroundColor: yAxisTick.color || '#e3e3e3',
        }"></view>
      </view>
      <view class="zx-bar__yAxis-linebox">
        <view class="zx-bar__yAxis-line" :class="{ 'zx-yAxis__line-first': idx === 0 }" v-for="(item, idx) in xAxisData"
          :key="idx" :style="{ borderLeftStyle: splitLine.type, borderLeftColor: splitLine.color }">
          <text class="zx-xAxis__val" :style="{
