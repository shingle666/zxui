<template>
    <view class="zx-editor">
        <view class="zx-border-b">
            <zx-textarea class="zx-editor-title" maxlength="-1" v-model="article.title" placeholder="# 请输入标题"
                auto-height />
        </view>
        ...
        <view v-if="!useEditor">
            <view v-for="(item, index) in article.contents" :key="index" class="zx-editor-items">
                ...
                <view class="zx-bg-gray zx-dark-bg-level-2" v-if="item.type == 'h3'">
                    <zx-textarea class="zx-editor-strong zx-border-box" :data-index="index" maxlength="-1"
                ...
                <view class="zx-bg-gray zx-dark-bg-level-2" v-else-if="item.type == 'txt'">
                    <zx-textarea class="zx-editor-txt zx-border-box" maxlength="-1" @blur="blur" :data-index="index"
                ...
                <view v-else-if="item.type == 'center'"
                    ...
                    style="padding:20rpx;">
                    <zx-input type="text" class="zx-editor-center" @blur="blur" maxlength="-1" :data-index="index"
                ...
                <view class="zx-bg-gray zx-dark-bg-level-2" v-else-if="item.type == 'quote'">
                    <zx-textarea class="zx-editor-quote zx-border-box" maxlength="-1" @blur="blur" :data-index="index"
                ...
                <view class="zx-bg-gray zx-dark-bg-level-2" v-else-if="item.type == 'code'">
                    <zx-textarea class="zx-editor-quote zx-border-box" maxlength="-1" @blur="blur" style="height:300rpx;"
                ...
                <view class="zx-bg-gray zx-dark-bg-level-2" v-else-if="item.type == 'link'">
                    <zx-input type="text" class="zx-editor-link zx-border-box" :focus="item.focusin" :data-index="index"
        ...
        <!-- 链接插入弹窗 -->
        <zx-popup ref="linkPopup" type="dialog">
            <zx-popup-dialog type="input" placeholder="请输入链接地址" title="插入链接" v-model="linkUrl"
