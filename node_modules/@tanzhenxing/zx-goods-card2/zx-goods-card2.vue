<template>
	<view :class="[
		...
		<view class="zx-goods-card2__image-wrapper">
			<slot name="image">
				<image v-if="image" :src="image" :mode="imageMode" class="zx-goods-card2__image" :lazy-load="lazyLoad"
		...
		<view class="zx-goods-card2__content">
			<!-- 标题标签 -->
			<view v-if="titleTag" class="zx-goods-card2__title-tag"
				:style="{ backgroundColor: titleTagBgColor, color: titleTagColor }">
				<slot name="titleTag">
			...
			<view v-if="description || $slots.description" class="zx-goods-card2__description">
				<slot name="description">
					<text v-if="description" class="zx-goods-card2__description-text"
			...
			<view v-if="tags && tags.length > 0" class="zx-goods-card2__tags">
				<slot name="tags">
					<view v-for="(tag, index) in tags" :key="index" class="zx-goods-card2__tag"
			...
			<view v-if="showPrice" class="zx-goods-card2__price-wrapper">
				<slot name="price">
					<view class="zx-goods-card2__price">
						...
						<text class="zx-goods-card2__price-integer" :style="{ color: priceColor }">{{ priceInteger
							}}</text>
						<text v-if="priceDecimal" class="zx-goods-card2__price-decimal"
							:style="{ color: priceColor }">.{{ priceDecimal }}</text>
					</view>
				</slot>
