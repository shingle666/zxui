<template>
  <zx-popup v-model:show="showPopup" type="bottom" :round="round" :duration="duration" :z-index="zIndex"
    :overlay="overlay" :overlay-style="overlayStyle" :close-on-click-overlay="closeOnClickOverlay" :safe-area="safeArea"
    @open="onOpen" @opened="onOpened" @close="onClose" @closed="onClosed">
      ...
      <view class="zx-popup-share__content">
        <scroll-view :scroll-y="true" class="zx-popup-share__scroll">
          <view class="zx-popup-share__options">
            <view v-for="(item, index) in shareOptions" :key="index" class="zx-popup-share__option"
              ...
              <view class="zx-popup-share__icon-wrapper" :style="iconWrapperStyle(item.icon)">
                ...
                <zx-icon v-else class="zx-popup-share__icon-text" :style="{ color: iconColor(item.icon) }">{{ 
                  getIconText(item.icon) }}</zx-icon>
              </view>
