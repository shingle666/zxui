    ...
    <view class="zx-cell__body" :class="[center && 'zx-cell--center', size === 'large' && 'zx-cell__body--large']">
      <view class="zx-cell__body__content">
        ...
        <view class="zx-cell__title">
          <slot name="title">
            <text v-if="title" class="zx-cell__title-text" :style="[titleTextStyle]" :class="[
          ...
          <slot name="label">
            <text class="zx-cell__label" v-if="label" :class="[
              disabled && 'zx-cell--disabled',
      ...
      <slot name="value">
        <text class="zx-cell__value" :class="[
          disabled && 'zx-cell--disabled',
      ...
      <view class="zx-cell__right-icon-wrap" v-if="$slots['right-icon'] || isLink"
        ...
        <zx-icon v-else :name="rightIcon" :custom-style="rightIconStyle" :color="disabled ? '#c8c9cc' : 'info'"
          :size="size === 'large' ? '36rpx' : '32rpx'"></zx-icon>
      </view>
    </view>
