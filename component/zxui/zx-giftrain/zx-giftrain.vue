<template>
  <view class="zx-giftrain" :style="{
    ...
    <view class="zx-giftrain-content" ref="rainContainer">
      <!-- 红包雨容器 -->
      <view v-for="(item, index) in rainItems" :key="index" class="zx-giftrain-item" :style="{
        left: item.left + 'px',
        top: item.top + 'px',
        width: rainWidth + 'px',
        ...
        <image :src="rainImg" mode="aspectFit" class="zx-giftrain-img" />
      </view>
    </view>
