<template>
	<view class="zx-tag-wrapper">
		<view class="zx-tag" :class="[
			...
			<text class="zx-tag__text" :style="[textColor]"
				:class="[`zx-tag__text--${type}`, plain && `zx-tag__text--${type}--plain`, `zx-tag__text--${size}`]">
				{{ text }}
			</text>
		</view>
		<view class="zx-tag__close" :class="[`zx-tag__close--${size}`]" v-if="closable" @tap.stop="closeHandler"
