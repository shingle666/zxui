<template>
  <view class="zx-dropdown" :class="[{ 'is-disabled': disabled }]">
    <!-- 触发元素 -->
    <view class="zx-dropdown__trigger" @click.stop="handleTriggerClick">
      <slot></slot>
    </view>

    <!-- 下拉菜单 -->
    <view v-if="visible" class="zx-dropdown__menu" :class="[`zx-dropdown__menu--${placement}`, popperClass]"
      :style="dropdownStyle" @click.stop="handleMenuClick">
