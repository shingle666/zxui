<template>
  <view class="zx-charts__radar-box" :style="{ width: radar_w + 'px' }">
    ...
    <view class="zx-charts-radar" :class="{ 'zx-radar__mrgin': label.show }"
      ...
      <view class="zx-radar__radius" v-for="(item, index) in indicators" :key="index" :style="{
        height: radar_w / 2 + 'px',
      ...
      <view class="zx-radar__center" :style="{ width: lineBold ? '2px' : '1px', height: lineBold ? '2px' : '1px' }">
        <view class="zx-radar__hypotenuse" v-for="(l, idx) in hypotenuse" :key="l.id" :style="{
          bottom: l.y + 'px',
          left: l.x + 'px',
          width: l.width + 'px',
        ...
        <view v-for="(item, index) in dataset" :key="index" @tap.stop="onDotTap(index)">
          <view class="zx-radar__dataset" v-for="(d, i) in item.lines" :key="d.id" :style="{
            bottom: d.y + 'px',
            left: d.x + 'px',
            width: d.width + 'px',
