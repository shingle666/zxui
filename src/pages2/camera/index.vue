<template>
	<view class="content">
		...
		<!-- 相机组件 -->
		<zx-camera ref="cameraRef" :mode="mode" :devicePosition="devicePosition" :frameSize="frameSize"
			:quality="quality" v-if="cameraVisible" @close="handleCameraClose" @photo="handlePhotoTaken"
			@video="handleVideoRecorded" @error="handleCameraError" @scan="handleScanCode"></zx-camera>
...
// 引用相机组件
import zxCamera from '@tanzhenxing/zx-camera/zx-camera.vue';
