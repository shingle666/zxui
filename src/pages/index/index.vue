...
const datalist = ref([
  ...
  },
  {
    ...
    lists: [
      ...
      { title: "address", path: "/pages3/address/index" },
      ...
      { title: "coupon2", path: "/pages3/coupon2/index" },
      { title: "Goods-card2 商品卡片2", path: "/pages3/goods-card2/index" },
      { title: "cart-bar", path: "/pages3/cart-bar/index" },
      ...
      { title: "invoice-title-list", path: "/pages3/invoice-title-list/index" },
      { title: "invoice-title-edit", path: "/pages3/invoice-title-edit/index" },
      { title: "delivery", path: "/pages3/delivery/index" },
      { title: "order-cancel-panel", path: "/pages3/order-cancel-panel/index" },
      { title: "order-remark", path: "/pages3/order-remark/index" },
      { title: "marquee 跑马灯抽奖", path: "/pages3/marquee/index" },
      { title: "scratchcard", path: "/pages3/scratchcard/index" },
      { title: "lottoroll 老虎机抽奖", path: "/pages3/lottoroll/index" },
      { title: "giftbox 神秘礼盒", path: "/pages3/giftbox/index" },
      { title: "hiteggs 砸金蛋抽奖", path: "/pages3/hiteggs/index" },
      { title: "giftrain 红包雨", path: "/pages3/giftrain/index" },
      { title: "luckshake 摇一摇抽奖", path: "/pages3/luckshake/index" },
    ]
  },
  {
    title: "反馈组件",
  ...
  },
  {
    ...
    lists: [
      ...
      { title: "shakedice 摇骰子", path: "/pages3/shakedice/index" },
    ]
  },
  {
    title: "图表/游戏",
  ...
  },
  {
    ...
    lists: [
     ...
     { title: "horizontal-scrolling", path: "/pages3/horizontal-scrolling/index" },
     { title: "gap", path: "/pages3/gap/index" },
     { title: "goods-filter", path: "/pages3/goods-filter/index" },
     { title: "quick-enter", path: "/pages3/quick-enter/index" },
