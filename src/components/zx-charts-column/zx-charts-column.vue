<template>
  <view class="zx-charts__column-wrap">
    ...
    <view class="zx-charts__column-box" v-if="xAxis.length > 0 && dataset.length > 0">
      <scroll-view
        :scroll-x="scrollable"
        class="zx-column__scroll-view"
        :style="{ height: scrollViewH + 'rpx' }"
      >
        <view
          :style="{ height: (xAxisVal.height || 2) + 'rpx' }"
          v-if="xAxisVal.show"
        ></view>
        <view class="zx-charts__column" :style="{ height: height + 'rpx' }">
          <view
            class="zx-column__item"
            :class="{
          ...
          >
            ...
            <view
              class="zx-column__bar"
              :class="{ 'zx-column__bar-round': columnCap === 'round' }"
