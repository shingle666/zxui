<template>
  <view
    class="zx-cell"
    :style="[customStyle]"
    :hover-class="!disabled && (clickable || isLink) ? 'zx-cell--clickable' : ''"
    :hover-stay-time="250"
    @tap="clickHandler"
  >
    <view
      class="zx-cell__body"
      :class="[center && 'zx-cell--center', size === 'large' && 'zx-cell__body--large']"
    >
        ...
        <view class="zx-cell__title">
          <slot name="title">
            <text
              ...
              :class="[
                disabled && 'zx-cell--disabled',
                size === 'large' && 'zx-cell__title-text--large',
              ]"
            >
              {{ title }}
            </text>
          ...
          <slot name="label">
            <text
              class="zx-cell__label"
              v-if="label"
              :class="[
                disabled && 'zx-cell--disabled',
                size === 'large' && 'zx-cell__label--large',
              ]"
              >{{ label }}</text
            >
          </slot>
      ...
      <slot name="value">
        <text
          class="zx-cell__value"
          :class="[
            disabled && 'zx-cell--disabled',
            size === 'large' && 'zx-cell__value--large',
          ]"
          >{{ value }}</text
        >
      </slot>
      <view
        class="zx-cell__right-icon-wrap"
