<template>
  ...
  >
    <view @tap.stop.prevent="stopfun" class="zx-bg-white zx-dark-bg-level-3">
      <view
        class="zx-flex zx-rows zx-space-between zx-align-items-center"
        style="padding: 20rpx"
      >
        <!-- 类型 -->
        <view style="width: 320rpx"
          ...
          ></zx-segmented
        ></view>
        <text class="zx-car-number-submit zx-block zx-primary-color" @tap="confirm"
          >确定</text
        >
      </view>
      <!-- 车牌展示 -->
      <view
        class="zx-flex zx-rows zx-nowrap zx-justify-content-center"
      ...
      <!-- 错误信息 -->
      <view v-if="errorshow" style="padding: 20rpx; margin-bottom: 10rpx"
        ><text class="zx-text zx-block zx-color-red zx-text-center"
          >请输入完整车牌号码</text
        ></view
      >
      <view style="padding: 15rpx">
        <!-- 省份前缀键盘 -->
        <view
          class="zx-flex zx-rows zx-wrap zx-overflow-hidden"
          :style="{ height: inputIndex == 0 ? '' : '0px' }"
        >
          <view
            class="zx-car-number-key zx-border"
            hover-class="zx-tap"
            :hover-stay-time="50"
        ...
        <!-- 号码键盘 -->
        <view
          class="zx-flex zx-rows zx-wrap zx-space-between zx-overflow-hidden"
          :style="{ height: inputIndex > 0 ? '' : '0px' }"
        >
          <view
            class="zx-car-number-key zx-border"
          ...
          <view class="zx-car-number-key" hover-class="zx-tap" @tap="deleteNumber">
            <text class="zx-car-number-key-txt zx-block zx-primary-text zx-icons"
              >&#xe623;</text
            >
          </view>
        </view>
