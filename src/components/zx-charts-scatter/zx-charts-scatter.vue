<template>
	<view class="zx-charts__scatter-wrap" :style="{ width: width + 'rpx' }">
		...
		<view class="zx-charts__scatter-box" :style="{ width: width + 'rpx', height: height + 'rpx' }">
			...
			>
				<view class="zx-xAxis__tickmarks" :style="{ height: xAxisTick.height || '12rpx', background: xAxisTick.color || '#e3e3e3' }"></view>
			...
			>
				<view class="zx-yAxis__tickmarks" :style="{ width: yAxisTick.width || '12rpx', background: yAxisTick.color || '#e3e3e3' }"></view>
