<template>
  <view class="zx-goods-comment">
      ...
      >
        ...
        <view class="zx-goods-comment__user">
          <view class="zx-goods-comment__avatar">
            <image 
              ...
              class="zx-goods-comment__avatar-img"
              :mode="avatarMode"
              :lazy-load="lazyLoad"
            />
          </view>
          <view class="zx-goods-comment__user-info">
            <text 
              class="zx-goods-comment__username"
              :style="{
          ...
          <view v-if="showActions" class="zx-goods-comment__actions">
            <view 
              class="zx-goods-comment__action"
              @click="handleReply(comment, index)"
            >
            ...
            >
              <text 
                class="zx-goods-comment__action-text"
                :class="{
              ...
              <text 
                ...
                class="zx-goods-comment__like-count"
              >
                ({{ comment.likeCount }})
              </text>
            </view>
        ...
        <view class="zx-goods-comment__content">
          ...
          <view 
            ...
            class="zx-goods-comment__images"
          >
            <image 
              v-for="(img, imgIndex) in comment.images.slice(0, maxImages)"
              :key="imgIndex"
              :src="img"
              class="zx-goods-comment__image"
              :mode="imageMode"
              :lazy-load="lazyLoad"
              @click="previewImage(comment.images, imgIndex)"
            />
            <view 
              v-if="comment.images.length > maxImages"
              class="zx-goods-comment__image-more"
        ...
        <view 
          ...
          class="zx-goods-comment__replies"
        >
          <view 
            v-for="(reply, replyIndex) in comment.replies.slice(0, maxReplies)"
          ...
          <view 
            v-if="comment.replies.length > maxReplies"
            class="zx-goods-comment__more-replies"
    ...
    <!-- 加载更多 -->
    <view 
      v-if="showLoadMore && commentList.length > 0"
      class="zx-goods-comment__load-more"
