...
const codeBlockStyle = computed(() => {
	return {
		...
		lineHeight: typeof props.lineHeight === 'number' ? `${props.lineHeight}rpx` : props.lineHeight
	}
})

const codeLineStyle = computed(() => {
	return {
		height: typeof props.lineHeight === 'number' ? `${props.lineHeight}rpx` : props.lineHeight,
