<template>
	<view class="zx-charts__funnel-wrap" :class="{ 'zx-charts__funnel-vertical': legend.direction !== 'vertical' }">
		<view class="zx-funnel__legend" :class="{ 'zx-legend__flex-column': legend.direction === 'vertical' }" v-if="legend.show">
			<view class="zx-funnel__legend-item" :style="{ marginLeft: legend.direction === 'vertical' ? '0' : '24rpx' }" v-for="(item, index) in dataset" :key="index">
